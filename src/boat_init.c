...
static void createKeyTables(void)
{
    ...
    _glfw.boat.keycodes[KEY_KPDOT]      = GLFW_KEY_KP_MULTIPLY;
    ...
    _glfw.boat.keycodes[KEY_KPCOMMA]    = GLFW_KEY_KP_DECIMAL;
...
int _glfwPlatformInit(void)
{
    ...
    _glfw.boat.boatlib.SetCursorPos = (PFN_BoatSetCursorPos)
        _glfw_dlsym(_glfw.boat.boatlib.handle, "boatSetCursorPos");
    _glfw.boat.boatlib.GetPrimaryClipString = (PFN_BoatGetPrimaryClipString)
        _glfw_dlsym(_glfw.boat.boatlib.handle, "boatGetPrimaryClipString");
    _glfw.boat.boatlib.SetPrimaryClipString = (PFN_BoatSetPrimaryClipString)
        _glfw_dlsym(_glfw.boat.boatlib.handle, "boatSetPrimaryClipString");
